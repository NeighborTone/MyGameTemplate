...
namespace Event
{
	...
	//	{
	//	private:
	//		std::vector<std::pair<Scene::SceneName , std::function<void(ECS::EntityManager&)>>> events_;
	//	public:
	//		/**
	//		* @brief  イベント関数を追加します
	...
	//		* @param  func イベント処理
	//		*/
	//		void addEvent(const Scene::SceneName state, std::function<void(ECS::EntityManager&)> func)
	//		{
